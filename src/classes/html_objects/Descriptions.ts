...
export const Descriptions = [
    new Description(
        ...
        `
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/7gPfb61GgcE?si=F0kA4Peu4Fj4tRXk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        `,
        [
            'images/mutiny1.png',
            'images/mutiny2.png',
...
<p>Les Behaviour Trees ont été utilisés pour développer des comportements d'IA pour les ennemis, leur permettant de réagir de manière réaliste aux actions du joueur. J'ai implémenté des arbres de décision qui permettent aux ennemis de choisir entre différentes actions en fonction de la situation, comme attaquer ou se déplacer pour se mettre en position avantageuse.</p>
    ...
    new Description(
        ...
        `
            ...
            <p>Ce projet, réalisé en 2 jours lors d'un hackaton, m'a permis de mettre en pratique mes compétences en développement web et de travailler sur un projet concret qui a un impact positif sur l'environnement et la mobilité urbaine.</p>
        `,
        [
